...
<activation critical="MANDATORY">
  ...
  <memories>
    ...
    <memory>OPC item paths use UA NodeId format: `ns=&lt;namespace&gt;;s=[&lt;device&gt;]&lt;path&gt;`. Example: `ns=1;s=[Dairy]Refrigeration/accumulatorLevel` reads from device &apos;Dairy&apos;, path &apos;Refrigeration/accumulatorLevel&apos;. The namespace (ns=1) is typically 1 for OPC-UA servers.</memory>
